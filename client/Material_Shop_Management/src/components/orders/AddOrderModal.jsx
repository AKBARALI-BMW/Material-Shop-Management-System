...
function AddOrderModal({ customers, products, onAdd, onClose }) {
  ...
  return (
    <Modal title="New Order" onClose={onClose}>
      ...
      {/* Error */}
      {formError && (
        <div className="font-mono flex items-center gap-2 bg-red-50 border border-red-200 text-red-700 rounded-lg px-3 py-2 text-xs mb-4">
          {formError}
        </div>
      )}
      ...
      <div className="mb-4">
        ...
        <select
          ...
          className=" font-mono w-full h-10 px-3 text-sm bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-none focus:border-orange-400 focus:ring-2 focus:ring-indigo-100 transition"
        >
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <button onClick={addItem}
            className="flex items-center gap-1 text-xs text-orange-400 hover:text-orange-500 font-mono">
            ...
            <div key={index} className="flex items-end gap-2">
              ...
              <div className="flex-1">
                ...
                <select
                  ...
                  className="w-full h-10 px-3 text-sm bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition"
                >
              ...
              <div className="w-16 ">
                ...
                <input type="number" min="1" value={item.qty}
                  ...
                  className="font-mono w-full h-10 px-2 text-sm bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition"
                />
              </div>
              ...
              <div className="w-24">
                ...
                <input type="number" value={item.price}
                  ...
                  placeholder="0"
                  className="w-full h-10 px-2 text-sm bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition"
                />
              </div>
      ...
      <div className="mb-5 font-mono">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-mono text-slate-500 uppercase tracking-wide">
              Due Date
            </label>
      ...
      <div className="flex gap-2">
        <button onClick={handleSubmit}
          className="font-mono flex-1 h-10 bg-orange-400 hover:bg-orange-500 text-white text-sm font-medium rounded-lg transition">
          Create Order
        </button>
        <button onClick={onClose}
          className=" font-mono flex-1 h-10 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-medium rounded-lg transition">
          Cancel
        </button>
      </div>
    </Modal>
