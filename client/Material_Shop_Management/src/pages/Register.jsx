    ...
    <div className="min-h-screen bg-slate-800 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
          <h2 className="text-xl font-serif text-slate-600 mb-1"><span className="text-amber-500">Create your</span>  account</h2>
          <p className="text-sm font-mono  text-slate-500 mb-6">Set up your shop management system</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-11 mt-2 bg-orange-400 hover:bg-amber-600 active:scale-[0.99] disabled:opacity-60 disabled:cursor-not-allowed text-white font-mono text-sm rounded-lg transition-all duration-150"
            >
              {loading ? (
          ...
          <p className="text-center text-sm text-slate-500 mt-5 font-mono">
            Already have an account?{" "}
          <Link to="/login" className="text-orange-500 font-serif hover:underline">
          Sign in
         </Link>
           </p>
        </div>
