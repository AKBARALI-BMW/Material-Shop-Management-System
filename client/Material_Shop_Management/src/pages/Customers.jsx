          ...
          <table className="w-full text-sm min-w-[520px]">
            <thead>
              <tr className="border-b border-slate-100">
                ...
                <th className="text-left text-xs text-slate-500 font-medium pb-2">Orders</th>
            ...
            <tbody>
              {customers.map((c) => (
                <tr key={c.name} className="border-b border-slate-50 last:border-0">
                  <td className="py-3 text-slate-800 font-medium whitespace-nowrap">{c.name}</td>
                  <td className="py-3 text-slate-500 whitespace-nowrap">{c.phone}</td>
                  <td className="py-3 text-slate-800">{c.orders}</td>
                  <td className="py-3 text-slate-800 whitespace-nowrap">{c.due}</td>
